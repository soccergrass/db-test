...
async function handleSubmit(e){
    ...
    const sendMessage = {id: stamp + '-' + MD5(useText).toString(), stamp, replied: false, replies: false, iden: isAuth, file: '', text: useText, category: document.getElementById('category').value || null, comment: isComment}
